...
sap.ui.define([
	...
	QUnit.test("Should provide the delivery status 'None' for Drawingo with no shipped date", function (assert) {
		deliveryTextTestCase.call(this, assert, "1128522175000", null, "None");
	});

	QUnit.test("Should provide the delivery status 'Urgent' for Drawingo with shipped date > required date", function (assert) {
		deliveryTextTestCase.call(this, assert, "1206800575000", "1206368675000", 1);
	});

	QUnit.test("Should provide the delivery status text 'In time' for Drawingo with shipped date > required date", function (assert) {
		deliveryTextTestCase.call(this, assert, "1129818175000", "1128522175000", 2);
	});

	QUnit.test("Should provide the delivery status text 'Too late' for Drawingo with shipped date > required date", function (assert) {
	...
	QUnit.test("Should return \"Warning\" state for Drawingo with no shipped date", function (assert) {
		deliveryStateTestCase.call(this, assert, "1206800575000", "1206368675000", "Warning");
	});

	QUnit.test("Should return \"Success\" status for Drawingo with shipped date > required date", function (assert) {
		deliveryStateTestCase.call(this, assert, "1129818175000", "1128522175000", "Success");
	});

	QUnit.test("Should return \"Error\" state for Drawingo with shipped date > required date", function (assert) {
