		...
		onTheMasterPage: {
			...
			actions: {
				...
				iRememberAnIdOfAnObjectThatsNotInTheList: function () {
					var aEntityData = this.getEntitySet("Drawingo");
					return this.waitFor({
						id: "list",
						matchers: new AggregationFilled({
							name: "items"
						...
						success: function (oList) {
							...
							oCurrentItem.bindingPath = "/" + oList.getModel().createKey("Drawingo", {
								OrderID: sCurrentId
							});
							...
							this.waitFor({
								...
								success: function () {
									this.waitFor({
										...
										errorMessage: "Did not find the " +  sOption + " option in Drawingo"
									});
								},
								errorMessage: "Did not find the Drawingo in filter dialog"
							});
						},
			...
			assertions: {
				...
				theListHeaderDisplaysZeroHits: function () {
					return this.theHeaderShouldDisplayDrawingo(0);
				},
				...
				theListShouldHaveAllEntries: function () {
					...
					return this.waitFor({
						id: "list",
						success: function (oList) {
							var aAllEntities = this.getEntitySet("Drawingo");
				...
				theHeaderShouldDisplayAllEntries: function () {
					return this.waitFor({
						...
						success: function (oList) {
							...
							return this.theHeaderShouldDisplayDrawingo(iExpectedLength);
						},
						errorMessage: "Can't find the master list"
					});
				},

				theHeaderShouldDisplayDrawingo: function (iDrawingo) {
					return this.waitFor({
						id: "masterHeaderTitle",
						matchers: new Properties({
							text: "Drawingo (" + iDrawingo + ")"
						}),
						success: function () {
							Opa5.assert.ok(true, "The master page header displays " + iDrawingo + " Drawingo");
						},
						errorMessage: "The  master page header does not display " + iDrawingo + " Drawingo."
					});
				},
				...
				theListShouldBeFilteredOnShippedDrawingo: function () {
