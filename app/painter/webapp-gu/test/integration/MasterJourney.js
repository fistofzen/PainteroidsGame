...
sap.ui.define([
	...
	opaTest("MasterList Filtering on Shipped Drawingo", function(Given, When, Then) {
		// Action
		When.onTheMasterPage.iFilterTheListOn("Only Shipped Drawingo");

		// Assertion
		Then.onTheMasterPage.theListShouldBeFilteredOnShippedDrawingo();
	});
